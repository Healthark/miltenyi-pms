...
| [11](./11-project-review-writes-migration.md) | Project-review writes: PrimaryEvaluationTab + SecondaryEvalTab | _pending_ | 3 queries + 6 mutations across two PM/Secondary tabs. **Cache-warming probe payoff** finally realized: PR #07's secondary-queue probe was warming this very tab's cache entry |

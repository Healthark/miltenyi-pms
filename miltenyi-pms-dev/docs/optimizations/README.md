...
| [15](./15-virtualization-management-review.md) | **Virtualization (theme #2 opener): ManagementReview calibration grid** | _pending_ | New theme arc — scaling. Installed `@tanstack/react-virtual`, refactored ManagementReview's table to a CSS-Grid + virtualized div structure. At 1000 staff: renders ~27 rows in DOM instead of 1000. Bundle: +5.86 KB gzip (vendor-cached one-time cost) |
